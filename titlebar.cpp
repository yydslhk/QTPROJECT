...
void MyTitleBar::initControl()
{
    ...
    m_pButtonMin->setIcon(style()->standardIcon(QStyle::SP_TitleBarMinButton));
    m_pButtonMax->setIcon(style()->standardIcon(QStyle::SP_TitleBarMaxButton));
    m_pButtonClose->setIcon(style()->standardIcon(QStyle::SP_TitleBarCloseButton));
